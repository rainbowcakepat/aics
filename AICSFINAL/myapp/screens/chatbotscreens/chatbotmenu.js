            ...
            <View style={chatbotMenuStyles.vCardContainer}>
              ...
              <View style={{flexDirection: 'row', justifyContent: 'flex-end'}}>
                <TouchableOpacity
                  ...
                  />
                  <Text style={chatbotMenuStyles.txtUpdateArchive}>
                    {' '}
                    Ask-ICS{' '}
                  </Text>
                </TouchableOpacity>
  ...
  return (
    <View style={chatbotMenuStyles.lgOverallContainer}>
      <View style={chatbotMenuStyles.lgTopHeader}>
        <View style={chatbotMenuStyles.headerIconsMenu}>
          <Icon
            style={chatbotMenuStyles.menuBarIcon}
            name="menu"
            color="white"
            type="ionicons"
            size={23}
          ...
          <Image
            ...
            style={chatbotMenuStyles.aicsLogo}
          />
        </View>
        ...
        <View style={{flexDirection: 'row'}}>
          <View>
            <Text
              ...
              style={chatbotMenuStyles.titleText}>
              CICS Chatbots
            </Text>
            <Text
              adjustsFontSizeToFit={true}
              style={chatbotMenuStyles.subtitleText}>
              Ask the official CICS Chatbots! Each chatbot corresponds to a
              specific category.
            </Text>
          </View>
        </View>
      ...
      <View style={chatbotMenuStyles.vSearchBar}>
        <Icon
          name="search"
          color="#B2B2B2"
          style={chatbotMenuStyles.searchBaricon}
          size={19}
        />
        <TextInput
          adjustsFontSizeToFit={true}
