...
import IngridChatbot from '../../screens/chatbotscreens/ingridchatbot';
...
export default class ChatbotApp2 extends Component {
  state = {
  ...
  render() {
    ...
    <View style={styles.header}>
        <Image style={styles.akisha} source={require('../../assets/ingridbot.png')} />
    </View>

      <IngridChatbot style={styles.containers}
      text = "Hi! It's your girl, Ingrid from UST-CICS.\n\nHow may I help you today?"
